...
//        7. Print the number of islands in your arraylist
        ...
        System.out.println("The number of islands are " + numberOfIslands);
...
//        1. Print out a list of the even integers
        ...
        for (int number : numbers) {
            if (number % 2 == 0) {
                evenNumbers.add(number);        //use .add to add elements into evenNumbers list
            }
...
//          So [7, 13, 2] would have sum of 9.
        ...
        System.out.println("Sum of numbers (w/o 13 onwards): " + total);
    }
}
